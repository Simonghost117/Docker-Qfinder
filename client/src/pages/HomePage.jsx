...
const HomePage = () => {
  return (
    ...
    <div className="absolute left-0 right-0 bg-white">
        <header className="sm:container mx-auto flex justify-between items-center py-2 px-3 lg:px-0 bg-white">
            <figure>
            <img
                src="images/logo.png"
            ...
            <li className="list-none">
                <a href="#" className="text-lg mq1200:text-xl uppercase font-medium text-black">
                Inicio
                </a>
            </li>
            <li className="list-none">
        ...
        <div
            id="header"
            style={{
                backgroundImage: 'url("/images/abuelosolo.jpg")',
